...
import { emitChat, subscribeChat } from '../socket';
...
function ChatInput(props) {
	...
	const testingEmit = async () => {
		console.log('u click me');
		subscribeChat();
		// const data = { recipient_id: 1, sender_id: 1, body: 'HEY U FROM CHRIS SS' }
		// try {
		//     const rs = await emitChat('send_chat', data);
		//     console.log(rs)
		// } catch (err) {
		//     console.log(err);
		// }
