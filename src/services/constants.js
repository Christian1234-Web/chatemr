...
export const payrollAPI = 'accountings/payroll';
...
export const allVitalItems = [
	{ name: 'Blood Pressure', unit: 'mmHg', category: ['general', 'labour'] },
	{ name: 'BMI', unit: 'kg/m²', category: ['general'] },
	{ name: 'BSA', unit: 'kg/m²', category: ['general'] },
	{ name: 'Contractions', unit: '', category: ['labour'] },
	{ name: 'Dilation', unit: 'cm', category: ['general', 'labour'] },
	{ name: 'Fetal Heart Rate', unit: 'bps', category: ['general', 'labour'] },
	{ name: 'Fundus Height', unit: 'cm', category: ['general'] },
	{ name: 'Glucose', unit: 'mg/dL', category: ['general', 'labour'] },
	{ name: 'Head Circumference', unit: 'cm', category: ['general'] },
	{ name: 'Height', unit: 'm', category: ['general'] },
	{ name: 'Length of Arm', unit: 'cm', category: ['general'] },
	{ name: 'MUAC', unit: '', category: ['general'] },
	{ name: 'Mid-Arm Circumference', unit: 'cm', category: ['general'] },
	{ name: 'Pain Scale', unit: '', category: ['general'] },
	{ name: 'PCV', unit: '%', category: ['general'] },
	{ name: 'Protein', unit: '', category: ['general'] },
	{ name: 'Pulse', unit: 'beats/min', category: ['general', 'pulse'] },
	{
		name: 'Respiration Rate',
		unit: 'breaths/min',
		category: ['general', 'labour'],
	},
	{ name: 'Servico Graph', unit: '', category: ['labour'] },
	{ name: 'SpO2', unit: '%', category: ['general'] },
	{ name: 'Surface Area', unit: 'cm²', category: ['general'] },
	{ name: 'Temperature', unit: '°C', category: ['general', 'labour'] },
	{ name: 'Urine', unit: '', category: ['general'] },
	{ name: 'Weight', unit: 'kg', category: ['general'] },
];
