	...
	const fetchNotes = useCallback(
		async page => {
			try {
				dispatch(startBlock());
				const p = page || 1;
				const url = `patient-notes?page=${p}&limit=10&antenatal_id=${antenatal.id}&type=patient-history&category=obstericHistory`;
	...
	return (
		<div className="col-sm-12">
			<div className="element-wrapper">
				...
				<h6 className="element-header">Obstetrics History</h6>
